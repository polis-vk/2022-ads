...
public class Sorts {
    ...
    public static <T extends Comparable<T>> void insertionSort(T[] array, int fromInclusive,
                                                               int toExclusive) {
    ...
    public static <T extends Comparable<T>> void improvedInsertionSort(T[] array) {
        improvedInsertionSort(array, 0, array.length);
    }

    public static <T extends Comparable<T>> void improvedInsertionSort(T[] array, int fromInclusive,
                                                                       int toExclusive) {
        for (int i = fromInclusive + 1; i < toExclusive; i++) {
            T key = array[i];
    ...
    public static <T extends Comparable<T>> void mergeSort(T[] array, T[] tempArray,
    ...
    public static <T extends Comparable<T>> void quickSort(T[] array, int fromInclusive, int toExclusive) {
        if (fromInclusive >= toExclusive - 1) {
            return;
        }
